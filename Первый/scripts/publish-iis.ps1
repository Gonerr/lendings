...
$backendProject = Join-Path $projectRoot "backend\FirstCompany.Api\FirstCompany.Api.csproj"
$wwwroot = Join-Path $projectRoot "backend\FirstCompany.Api\wwwroot"
$frontendOutput = Join-Path $projectRoot "out"
