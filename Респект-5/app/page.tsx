    ...
    <main>
      <header className="site-header">
        ...
        <nav className={menuOpen ? "nav nav-open" : "nav"} aria-label="Основная навигация">
          ...
          <a href="#dispatch" onClick={closeMenu}>Диспетчерская</a>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <p className="hero-text">
            Круглосуточное присутствие персонала, диспетчеризация МКД, консьерж-сервис
            и административное сопровождение объектов управляющих компаний.
          </p>
      ...
      <section className="dispatch" id="dispatch">
        <div className="dispatch-head section-shell">
          ...
          <p className="dispatch-lead">
            Технические средства обнаруживают проблему, а сотрудник принимает обращение,
            фиксирует его и передаёт профильной службе. Такой подход помогает управляющей
            компании сохранять контроль, а жителям — быстрее получать понятную обратную связь.
          </p>
        </div>
        ...
        <div className="dispatch-layout section-shell">
          <div className="dispatch-visual">
            <div className="dispatch-visual-top">
              ...
              <span className="dispatch-online"><i /> Связь установлена</span>
            </div>
            <img
            ...
            <div className="dispatch-monitoring">
              <div><small>Обращения</small><strong>приём и фиксация</strong></div>
              <div><small>Инженерные системы</small><strong>контроль состояния</strong></div>
              <div><small>Реакция</small><strong>передача в службу</strong></div>
            </div>
          </div>
          ...
          <div className="dispatch-content">
            ...
            <ol className="dispatch-flow">
              <li>
                <span>01</span>
                <div><h3>Житель сообщает</h3><p>По телефону, при личном визите или через переговорное устройство в подъезде и лифте.</p></div>
              </li>
              <li>
                <span>02</span>
                <div><h3>Диспетчер фиксирует</h3><p>Обращение регистрируется в журнале или электронной системе учёта.</p></div>
              </li>
              <li>
                <span>03</span>
                <div><h3>Заявка уходит специалистам</h3><p>Информация о неисправности передаётся профильной службе или управляющей компании.</p></div>
              </li>
              <li>
                <span>04</span>
                <div><h3>Результат остаётся под контролем</h3><p>Сохраняется история обращения и подтверждается выполнение необходимых действий.</p></div>
              </li>
            </ol>
          </div>
        </div>
        ...
        <div className="dispatch-zones section-shell">
          ...
          <ul>
            <li><span>01</span><p>Общее имущество, инженерные коммуникации и оборудование дома</p></li>
            <li><span>02</span><p>Порядок в общих зонах и состояние придомовой территории</p></li>
            <li><span>03</span><p>Доступ жителей, посетителей и автотранспорта на территорию</p></li>
            <li><span>04</span><p>Оперативная реакция при аварии или угрозе её возникновения</p></li>
          </ul>
        </div>
      </section>
