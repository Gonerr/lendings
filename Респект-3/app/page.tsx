...
const workflow = [
  [
    "01",
    "Заявка",
    "Получаем задачу от управляющей компании и фиксируем исходные данные по объекту.",
  ],
  [
    "02",
    "Распределение",
    "Определяем профиль работ и направляем подходящего технического специалиста.",
  ],
  [
    "03",
    "Выполнение",
    "Проводим диагностику и выполняем согласованный объём работ на объекте.",
  ],
  [
    "04",
    "Результат",
    "Передаём информацию о выполнении и необходимых дальнейших действиях.",
  ],
];
...
const requisites = [
  ...
  [
    "Юридический адрес",
    "196084, Санкт-Петербург, ул. Киевская, д. 3, литера А, пом. 33-Н, офис 1",
  ],
];
    ...
    <main id="top">
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Респект-3 — на главную">
          ...
          <span className="brand-copy">
            <strong>РЕСПЕКТ-3</strong>
            <small>Техническое сопровождение</small>
          </span>
        </a>
        ...
        <button className="header-action" type="button" onClick={openForm}>
      ...
      <section className="hero">
        <div className="hero-copy">
          <div className="hero-meta">
            ...
            <span>Основано в 2004 году</span>
          </div>
          ...
          <p className="hero-lead">
            ООО «Респект-3» обеспечивает техническое сопровождение объектов
            управляющих компаний «Континент»: сантехнические, электротехнические
            и плотницкие работы.
          </p>
          <div className="hero-actions">
            <button className="primary-action" type="button" onClick={openForm}>
              Поставить задачу <span>↗</span>
            </button>
            <a href="#services">
              Наши направления <span>↓</span>
            </a>
          </div>
        </div>
        ...
        <div className="system-board" aria-hidden="true">
          <div className="board-head">
            <span>BUILDING / SERVICE BOARD</span>
            <span>R3 · SPB</span>
          </div>
      ...
      <section className="about section-shell" id="about">
        ...
        <div className="about-content">
          ...
          <h2>
            Техническая работа,
            <br />
            которую <em>видно по результату.</em>
          </h2>
          <div className="about-grid">
            <p className="about-lead">
              Мы помогаем управляющим компаниям поддерживать общее имущество и
              инженерные системы жилых домов в рабочем состоянии.
            </p>
            <div>
              <p>
                Техническое сопровождение складывается из десятков регулярных и
                срочных задач. Для каждой из них нужен специалист нужного
                профиля, понятная постановка и контроль результата.
              </p>
              <p>
                «Респект-3» объединяет сантехнические, электротехнические и
                плотницкие работы в единый рабочий контур для управляющих
                компаний «Континент».
              </p>
            </div>
          </div>
      ...
      <section className="services" id="services">
        <div className="services-head section-shell">
          <div className="section-side light">
            <span>02</span>
            <p>Направления</p>
          </div>
          <div>
            <p className="kicker">PLUMBING / ELECTRICAL / CARPENTRY</p>
            <h2>
              Три профиля.
              <br />
              Одна техническая служба.
            </h2>
          </div>
        </div>
        ...
        <p className="service-note section-shell">
          Конкретный состав, сроки и условия работ определяются договором с
          управляющей компанией и параметрами объекта.
        </p>
      </section>
        ...
        <div className="partner-shell section-shell">
          ...
          >
            <span className="kontinent-logo">
              ...
              <span>
                <strong>Континент</strong>
                <small>Управляющая компания</small>
              </span>
            </span>
          ...
          <div className="partner-copy">
            ...
            <p>
              УК «Континент» управляет многоквартирными домами, обслуживает
              инженерные сети и оборудование жилых комплексов Санкт-Петербурга.
              В этом рабочем контуре «Респект-3» обеспечивает выполнение
              сантехнических, электротехнических и плотницких задач.
            </p>
            <div
              className="partner-facts"
              aria-label="Задачи технического сопровождения"
            >
              <span>Инженерные системы</span>
              <span>Общее имущество</span>
            ...
            <a
              ...
              rel="noreferrer"
            >
              Официальный сайт УК «Континент» <span>↗</span>
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="contact-shell section-shell">
          <div>
            ...
            <button
              ...
              onClick={openForm}
            >
              Подготовить заявку <span>↗</span>
            </button>
          </div>
          <address>
            <div>
              <span>Организация</span>
              <strong>ООО «Респект - 3»</strong>
            </div>
            <div>
                ...
                <form onSubmit={submit}>
                  ...
                  <label>
                    ...
                    >
                      ...
                      <option>Электротехнические работы</option>
                      <option>Плотницкие работы</option>
                      <option>Комплексная техническая задача</option>
                    </select>
                  </label>
                  ...
                  <label className="consent">
                    ...
                    <span>
                      Согласен(на) на обработку указанных данных для подготовки
                      обращения
                    </span>
                  </label>
